...
<template>
    <div>
        ...
        <h2>Form</h2>
        <div class="component-wrap">
            <sunset-form ref="form" :options="options"></sunset-form>
                ...
                fields: [
                        ...
                        widgets: [
                            {
                                ...
                                name: "checkmethod",
                                wrapstyle:
                                    "width:50%;padding-right:5px;box-sizing:border-box;",
                                cols: 2,
                                placeholder: "检查方法",
                                data: {
                                    "1": "aaa",
                            ...
                            },
                            {
                                ...
                                name: "checkpoint",
                                wrapstyle:
                                    "width:25%;padding-right:5px;box-sizing:border-box;",
                                cols: 2,
                                placeholder: "部位"
                            },
                            {
                    ...
                    },
                    {
                        ...
                        operate(model, options, formOptions) {
                            formOptions.fields.splice(
                                formOptions.fields.length - 1,
                                0,
                                {
                                    cols: 16,
                                    name: "checkmethod",
            ...
            options: {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        widget: "file",
                        dom:
                            '<div style="display:inline-block;width:50px;height:50px;border:1px solid #ccc;">1234</div>',
                        ...
                        thumbnail: (result, file) => {
                            return (
                                result &&
                                `/upload/api/1.0.0/file/acquisition/${result}`
                            );
                        },
                        thumbnailRender(src) {
