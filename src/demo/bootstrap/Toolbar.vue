...
<template>
    <div>
        ...
        <h2>Switch</h2>
        <div class="component-wrap">
            <sunset-switch v-model="switchValue" :options="{disabled:true}" @change="switchChange"></sunset-switch>{{switchValue}}
        </div>
        <h2>Toolbar</h2>
        <div class="component-wrap">
        ...
        <div>
            <sunset-chart ref="chart" style="width:400px;height:200px;" :options="echartsOptions" @chart-click="chartClick"></sunset-chart>
        </div>
        <h2>Coder</h2>
        <div class="component-wrap">
            <sunset-coder v-model="coderV" :readonly="false" style="height:150px;"></sunset-coder>
        </div>
        {{coderV}}
    </div>
</template>
